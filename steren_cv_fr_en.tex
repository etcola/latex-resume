...
\begin{tabular}{cp{0.8\textwidth}}
\textbf{2009-2010}						& \trad{Engineer at \textit{Dassault Systèmes}:}{Ingénieur-Designer chez \textit{Dassault Systèmes} :}\\
                                        & \trad{Front-end development for an innovative social platform. -- 1 year}{Développement front-end d'une plateforme innovante de web social  -- 1 an} \\
\espace
